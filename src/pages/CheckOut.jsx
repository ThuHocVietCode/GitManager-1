              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="input-group mb-3">
                    <span className="input-group-text" id="basic-addon1">Dịch vụ</span>
                    <input
                      type="text"
                      ...
                      value={selectedCustomerCheckout.service_name || ''}
                      readOnly
                    />
                  </div>
                  <div className="input-group mb-3">
                    <span className="input-group-text" id="basic-addon1">Tên khách</span>
                    <input
                      type="text"
                      className="form-control"
                      ...
                      aria-describedby="basic-addon1"
                      value={selectedCustomerCheckout.name || ''}
                      readOnly
                    />
                  </div>
                  <div className="input-group mb-3">
                    ...
                    <input
                      ...
                      aria-label="Email"
                      aria-describedby="basic-addon1"
                      value={selectedCustomerCheckout.email || ''}
                      readOnly
                    />
                  </div>
                  <div className="input-group mb-3">
                    ...
                    <input
                      ...
                      aria-label="Phone"
                      aria-describedby="basic-addon1"
                      value={selectedCustomerCheckout.phone || ''}
                      readOnly
                    />
                  </div>
                  <div className="input-group mb-3">
                    ...
                    <input
                      ...
                      aria-label="Time"
                      aria-describedby="basic-addon1"
                      value={selectedCustomerCheckout.time || ''}
                      readOnly
                    />
                  </div>
                </div>
                <div className="modal-footer">
                  <button type="button" className="btn btn-danger" onClick={handleClose}>Đóng</button>
                </div>
              </div>
            </div>
          </div>
